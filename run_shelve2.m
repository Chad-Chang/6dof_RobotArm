function [robot_op] = run_shelve2(robot_op,commu, n,iteration,s,visual) % strech the arm to insert
%     if robot_op.m_status ==6 % 
        ttform = [0,-1,0,2;-1,0,0,0;0,0,-1,0.8;0,0,0,1;];
