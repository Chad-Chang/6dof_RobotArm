function [robot_op] = run_shelve1(robot_op, commu, n, iteration, s,visual) % strech the arm to insert
%     if robot_op.m_status ==5 % 
        ttform = [0,-1,0,1.5;-1,0,0,0;0,0,-1,0.8;0,0,0,1;];
